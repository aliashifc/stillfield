...
- `src/components/Sound.tsx` (`client:idle`) — renders nothing; reveals + wires the `[data-sound]` toggle (server-rendered with `hidden`) to procedural brown noise.
